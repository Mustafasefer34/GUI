# -*- coding: utf-8 -*-
"""
Created on Tue Sep 24 11:44:04 2024
...
#button
open_button=ttk.Button(frame1,text="Open Trading",command=openTrade)
open_button.grid(row=2,column=1,padx=25,pady=25)

#frame 3 text editor, scroll bar
...
#frame2: tab veiw, radio button, button, result label, plot
...
start_button=ttk.Button(frame2,text="Start Trading",command=startTrading)
